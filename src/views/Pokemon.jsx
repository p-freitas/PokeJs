...
import { POKEMON_GIF_URL, POKEMON_BG } from '../helpers/config';
...
const Pokemon = () => {
    ...
    return (
        ...
        <div className='Wrapper' style={{backgroundImage: `url(${POKEMON_BG + pokemon.name}.jpg)`}}>
            ...
            <div className='pokedex'>
                <div className='inner-container'>
                    ...
                    <RightPanel imageEvolution1={pokemon.evolutionChain.chain.evolves_to[0]? POKEMON_GIF_URL + pokemon.evolutionChain.chain.evolves_to[0].species.name + '.gif' : OpenPokeball}
                     ...
                     pokemon={pokemon}/>
                     {console.log(POKEMON_BG[pokemon.types[0].type.name])}
                </div>
            </div>
        </div>
    );
